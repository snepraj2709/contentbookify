  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold tracking-tight">Step 3: Design Your Book Cover</h2>
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    disabled={!canGenerateMoreCovers || isGenerating || !promptText.trim()}
                    className="w-full"
                  >
                    {isGenerating ? (
                      <>
              ...
              >
                ...
                {state.book.coverImage.name && (
                  <p className="text-center text-sm text-muted-foreground mt-3">
                    {state.book.coverImage.type === 'template' ? 'Template: ' : 
                     state.book.coverImage.type === 'upload' ? 'Uploaded: ' : 
                     state.book.coverImage.type === 'generated' ? 'Generated: ' : ''}
                    {state.book.coverImage.name}
                  </p>
                )}
              </motion.div>
